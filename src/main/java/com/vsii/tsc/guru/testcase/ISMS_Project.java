...
public void TC36(String user, String pass, String Description, String Descripex, String StageExp) throws InterruptedException{     
TestBase.methodName = "TC36";       
objProject.editTaskToKiemtra1Succ( user,  pass,  Description,  Descripex,  StageExp); 
}
